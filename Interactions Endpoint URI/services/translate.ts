...
export async function TranslateContent(selectedLanguage: string, content: string): Promise<IBXTranslationObject> {
...
export async function TranslateInteractionContent(interaction_data: APIApplicationCommandInteractionDataOption[]): Promise<IBXTranslationObject> {
